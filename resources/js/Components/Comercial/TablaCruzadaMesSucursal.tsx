...
import { mesesOrden } from '@/utils/constantes'; // Asegúrate que este archivo existe
...
export default function TablaCruzadaMesSucursal({ datos = [], titulo = 'Tabla Resumen Altas y Bajas' }: Props) {
